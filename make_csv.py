...
comparison_task_json = 'server/data/comparison_tasks.json'
...
if not os.path.exists('server/data/task_links/'):
    os.makedirs('server/data/task_links/')

for i in range(batches):
    with open(f'server/data/task_links/hit_links_{i}.csv', 'w') as f:
        f.write('HIT_Link\n')
